...
type CustomerOrder struct {
	...
	OrderData  types.JSON `boil:"order_data" json:"order_data" toml:"order_data" yaml:"order_data"`
...
var CustomerOrderWhere = struct {
	ID         whereHelperint
	OrderData  whereHelpertypes_JSON
	UserID     whereHelperstring
	UpdateTime whereHelpertime_Time
	CreateTime whereHelpertime_Time
}{
	ID:         whereHelperint{field: "\"customer_order\".\"id\""},
	OrderData:  whereHelpertypes_JSON{field: "\"customer_order\".\"order_data\""},
	UserID:     whereHelperstring{field: "\"customer_order\".\"user_id\""},
	UpdateTime: whereHelpertime_Time{field: "\"customer_order\".\"update_time\""},
	CreateTime: whereHelpertime_Time{field: "\"customer_order\".\"create_time\""},
}
...
var (
	customerOrderAllColumns            = []string{"id", "order_data", "user_id", "update_time", "create_time"}
	customerOrderColumnsWithoutDefault = []string{"order_data", "user_id"}
	customerOrderColumnsWithDefault    = []string{"id", "update_time", "create_time"}
...
func (q customerOrderQuery) One(ctx context.Context, exec boil.ContextExecutor) (*CustomerOrder, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for customer_order")
	}
...
func (q customerOrderQuery) All(ctx context.Context, exec boil.ContextExecutor) (CustomerOrderSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to CustomerOrder slice")
	}
...
func (q customerOrderQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count customer_order rows")
	}
...
func (q customerOrderQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if customer_order exists")
	}
...
func (o *CustomerOrder) User(mods ...qm.QueryMod) userAccountQuery {
...
func (customerOrderL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCustomerOrder interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`user_account`), qm.WhereIn(`user_account.id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		...
		foreign.R.UserCustomerOrders = append(foreign.R.UserCustomerOrders, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.UserID == foreign.ID {
				...
				foreign.R.UserCustomerOrders = append(foreign.R.UserCustomerOrders, local)
				break
			}
		}
	}
...
// SetUser of the customerOrder to the related item.
// Sets o.R.User to related.
// Adds o to related.R.UserCustomerOrders.
func (o *CustomerOrder) SetUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *UserAccount) error {
	var err error
	if insert {
	...
	updateQuery := fmt.Sprintf(
		"UPDATE \"customer_order\" SET %s WHERE %s",
		strmangle.SetParamNames("\"", "\"", 1, []string{"user_id"}),
		strmangle.WhereClause("\"", "\"", 2, customerOrderPrimaryKeyColumns),
	)
	...
	if related.R == nil {
		related.R = &userAccountR{
			UserCustomerOrders: CustomerOrderSlice{o},
		}
	} else {
		related.R.UserCustomerOrders = append(related.R.UserCustomerOrders, o)
	}
...
func FindCustomerOrder(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*CustomerOrder, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from customer_order")
	}
...
func (o *CustomerOrder) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("model: no customer_order provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into customer_order")
	}
...
func (o *CustomerOrder) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update customer_order, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update customer_order row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for customer_order")
	}
...
func (q customerOrderQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all for customer_order")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for customer_order")
	}
...
func (o CustomerOrderSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all in customerOrder slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected all in update all customerOrder")
	}
	return rowsAff, nil
}
...
func (o *CustomerOrder) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("model: no customer_order provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("model: unable to upsert customer_order, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert customer_order")
	}
...
func (o *CustomerOrder) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("model: no CustomerOrder provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete from customer_order")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for customer_order")
	}
...
func (q customerOrderQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("model: no customerOrderQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from customer_order")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for customer_order")
	}
...
func (o CustomerOrderSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from customerOrder slice")
	}
...
func (o *CustomerOrderSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to reload all in CustomerOrderSlice")
	}
...
func CustomerOrderExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if customer_order exists")
	}
